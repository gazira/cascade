...
}, {"component/jquery@1.0.0":2,"../index":3,"./data":4}],
...
module.exports = require('./src/cascade');
}, {"./src/cascade":5}],
...
var Cascade = Widget.extend({
    ...
    _getData: function (index) {
        ...
        if (item) {
            ...
            if ($.isFunction(data)) {
                data = data.call(this, this.$('select').eq(index - 1), index);
            }
...
}, {"jquery":2,"widget":6,"ajax.single":7}],
...
var data = [
    {
        ...
        data: [
            {value: '100', text: '北京'},
            {value: '101', text: '广东'},
            {value: '102', text: '福建', selected: true}
        ]
    },
    {
        name: 'city',
    ...
    },
    {
        ...
        data: [
            [
                [
                    {value: '10010', text: '东城区'},
                    {value: '10011', text: '西城区'},
                    {value: '10012', text: '崇文区'},
                    {value: '10013', text: '宣武区'}
                ]
            ],
            [
                [
                    {value: '10100', text: '天河区'},
                    {value: '10101', text: '越秀区'}
                ],
                [
                    {value: '10110', text: '福田区'},
                    {value: '10111', text: '罗湖区'},
                    {value: '10112', text: '南山区'}
                ]
            ],
            [
                [
                    {value: '10200', text: '鼓楼区'},
                    {value: '10201', text: '台江区'},
                    {value: '10202', text: '闽侯县'}
                ],
                [
                    {value: '10210', text: '思明区'},
                    {value: '10211', text: '翔安区'},
                    {value: '10212', text: '海沧区'}
                ],
                [
                    {value: '10220', text: '梅列区'},
                    {value: '10221', text: '三元区'}
                ]
            ]
        ]
    }
